...
> A curated collection of OpenClaw agent skills built and maintained by [Devx AI Labs](https://github.com/devx-ai-labs).
...
3. **Add your skill** in the `skills/` folder following the [template](./skills/_template/)
...
> ⚠️ All PRs are reviewed and approved by [@brijeshdevx](https://github.com/brijeshdevx). Only approved skills merge to `main`.
...
Built with ❤️ by [Devx AI Labs](https://devxlabs.ai)
